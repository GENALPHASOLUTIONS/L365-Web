...
export default function Footer() {
  return (
    <footer className="bg-[#0F1923] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-1">
          <img src="/logo.png" alt="Logistics 365" className="h-14 w-auto mb-4 brightness-0 invert" />
          <p className="text-sm leading-relaxed text-gray-400">Seamless Synergy in global freight forwarding. Your cargo, our commitment — 365 days a year.</p>
        </div>
        <div>
          <h4 className="text-white font-bold mb-4 text-sm tracking-widest uppercase">Quick Links</h4>
          <ul className="space-y-2 text-sm">
            {[['Home', '/'], ['About Us', '/about'], ['Services', '/services'], ['Network', '/network'], ['Contact', '/contact']].map(([l, h]) => (
